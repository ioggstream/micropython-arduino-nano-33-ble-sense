...
# v1.0 2016.4
# v2.0 2019.7
# Author: ioggstream (robipolli@gmail.com):
#   update registries.
# v3.0 2025.1

# From https://github.com/arduino-libraries/Arduino_LPS22HB/blob/master/src/BARO.cpp
LPS22HB_ADDRESS    = const(0x5C)
...
LPS22_PRESS_OUT_H  = const(0x2a)
LPS22_TEMP_OUT_L   = const(0x2B)
LPS22_TEMP_OUT_H   = const(0x2c)


class LPS22():
    def __init__(self, i2c, addr = LPS22HB_ADDRESS):
        self.i2c = i2c
        self.addr = addr
        self.tb = bytearray(1)
        self.rb = bytearray(1)
